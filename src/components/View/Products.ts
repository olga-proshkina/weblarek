...
class Product<T> extends Component<IProduct & T> {
  ...
  constructor(container: HTMLElement) {
    super(container);
    this.productTitle = ensureElement<HTMLHeadingElement>(
      ".card__title",
      this.container,
    );
    this.productPrice = ensureElement<HTMLElement>(
      ".card__price",
      this.container,
    );
  }
...
export class ProductGalleryView extends Product<IProduct> {
  ...
  constructor(container: HTMLElement, actions?: ICardActions) {
    ...
    this.productCategory = ensureElement<HTMLElement>(
      ".card__category",
      this.container,
    );
    this.productImage = ensureElement<HTMLImageElement>(
      ".card__image",
      this.container,
    );
...
export class ProductPreview extends Product<IProduct> {
  ...
  constructor(
    ...
    this.productDescription = ensureElement<HTMLElement>(
      ".card__text",
      this.container,
    );
    this.productAddRemoveButton = ensureElement<HTMLButtonElement>(
      ".card__button",
      this.container,
    );
...
export class ProductCartView extends Product<IProduct> {
  ...
  constructor(container: HTMLElement, actions?: ICardActions) {
    super(container);
    this.productIndex = ensureElement<HTMLElement>(
      ".basket__item-index",
      this.container,
    );
    this.productRemoveButton = ensureElement<HTMLButtonElement>(
      ".basket__item-delete",
      this.container,
    );
