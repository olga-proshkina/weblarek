...
export class OrderForm extends Form<IForm> {
  ...
  constructor(
    ...
    this.paymentsCashButton = ensureElement<HTMLButtonElement>(
      'button[name="cash"]',
      this.container,
    );
    this.inputAddressField = ensureElement<HTMLInputElement>(
      "input[name=address]",
      this.container,
    );
...
export class ContactsForm extends Form<IForm> {
  ...
  constructor(
    ...
    super(events, container);
    this.inputEmailField = ensureElement<HTMLInputElement>(
      "input[name=email]",
      this.container,
    );
    this.inputPhoneField = ensureElement<HTMLInputElement>(
      "input[name=phone]",
      this.container,
    );
